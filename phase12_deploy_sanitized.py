...
def main():
    ...
    original_model_path = "runs/detect/runs/custom_219d4d96/weights/best.onnx"
    sanitized_model_path = "phase12/custom_model/best_sanitized.onnx"
    if not os.path.exists(sanitized_model_path):
        print(f"Error: Model not found at {sanitized_model_path}")
        sys.exit(1)
    print("Sanitized Model found.")
    ...
    benchmark = {
      ...
      "sanitized_model": sanitized_model_path,
