...
1. **Application Layer**: A Streamlit-based interface that maintains configuration state, handles ZIP dataset ingestion, and visualizes progress across the 8-step business workflow.
